...
class LocaleString extends Translations{
  ...
  Map<String, Map<String, String>> get keys => {
    'uz_UZ': {
      ...
      'delete log':'Hisobingizni o‘chirganingizdan so‘ng hisob ma’lumotlaringizni tiklashning imkoniyati yo‘q.',
    ...
    'en_EN': {
      ...
      'delete log':'Once you delete your account, there is no way to recover your account information.',
    ...
    'ru_RU': {
      ...
      'delete log':'После удаления учетной записи восстановить информацию об учетной записи будет невозможно.',
    ...
    'oz_OZ': {
      ...
      'delete log':'Ҳисобингизни ўчирганингиздан сўнг ҳисоб маълумотларингизни тиклашнинг имконияти йўқ.',
