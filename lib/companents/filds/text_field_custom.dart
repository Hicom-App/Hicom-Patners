...
class TextFieldCustom extends StatelessWidget{
  ...
  TextFieldCustom({super.key, required this.fillColor,required this.hint, this.icons});
    ...
    return Container(
        ...
        child: TextField(
            ...
            decoration: InputDecoration(
                ...
                //prefixIcon: Padding(padding: EdgeInsets.all(Get.height * 0.013), child: Icon(icons, color: Theme.of(context).colorScheme.onSurface)),
                prefixIcon: icons != null ? Padding(padding: EdgeInsets.all(Get.height * 0.013), child: Icon(icons, color: Theme.of(context).colorScheme.onSurface)) : null,
