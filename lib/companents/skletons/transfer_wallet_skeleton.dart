              ...
              children: [
                              ...
                              children: [
                                ...
                                Row(
                                    children: [
                                      ...
                                      TextSmall(text: ' so`m'.tr, color: AppColors.black, fontWeight: FontWeight.w500)
                                    ]
                                )
                              ]
                          )
                ...
                Container(
                    ...
                    child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Container(height: 50.h, width: 50.w, margin: EdgeInsets.only(right: 10.w, top: 15.h, bottom: 10.h), child: SvgPicture.asset('assets/svg_assets/uz_card.svg', colorFilter: const ColorFilter.mode(AppColors.white, BlendMode.srcIn), fit: BoxFit.contain)),
                ...
                Container(width: Get.width, margin: EdgeInsets.only(left: 15.w, right: 15.w, top: 20.h, bottom: 10.h), child: TextSmall(text: 'To`lov summasi'.tr, color: AppColors.black, fontWeight: FontWeight.w500)),
