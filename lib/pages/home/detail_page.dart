                      ...
                      children: [
                        Row(
                            ...
                            children: [
                              ...
                              _getController.productsModelDetail.value.result != null
                                  ? InkWell(onTap: () => ApiController().addFavorites(_getController.productsModelDetail.value.result!.first.id!, isProduct: _getController.productsModelDetail.value.result!.first.favorite == 0 ? true : false).then((value) =>
                                  ApiController().getProduct(id!, isCategory: false).then((_) => _getController.updateFavoriteAllModels(_getController.productsModelDetail.value.result!.first.id!.toInt(), _getController.productsModelDetail.value.result!.first.favorite == 0 ? 0 : 1))
                              ),
                                    ...
                                    children: [
                                      Row(children: [
                                        Container(
                                            ...
                                            decoration: const BoxDecoration(shape: BoxShape.circle, boxShadow: [BoxShadow(color: AppColors.grey, spreadRadius: 0.22, blurRadius: 25)]), child: ClipOval(child: FadeInImage(image: _getController.reviewsModel.value.result![index].userAvatar != null || _getController.reviewsModel.value.result![index].userAvatar != '' ? NetworkImage(_getController.reviewsModel.value.result![index].userAvatar.toString()) : const AssetImage('assets/images/logo_back.png'), placeholder: const AssetImage('assets/images/logo_back.png'), imageErrorBuilder: (context, error, stackTrace) => Container(decoration: const BoxDecoration(image: DecorationImage(image: NetworkImage('https://avatars.mds.yandex.net/i?id=04a44da22808ead8020a647bb3f768d2_sr-7185373-images-thumbs&n=13'), fit: BoxFit.cover))), fit: BoxFit.cover))
                                        ),
