                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            if (_getController.productsModelDetail.value.result != null && _getController.productsModelDetail.value.result!.first.description != null)
                              _getController.productsModelDetail.value.result!.first.description != ''
                                  ? const TextSmall(text: 'Tavsif', color: AppColors.blue, fontWeight: FontWeight.bold)
                                  : const SizedBox(),
                            Obx(() => _getController.productsModelDetail.value.result != null && _getController.productsModelDetail.value.result!.first.description != null
                                ? Container(
                                width: Get.width,
                                padding: EdgeInsets.only(top: Get.height * 0.01),
                                child: _getController.productsModelDetail.value.result!.first.description != ''
                                    ? Column(
                                    children: [
                                      AnimatedSize(
