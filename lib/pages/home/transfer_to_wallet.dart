                      ...
                      child: Column(
                          children: [
                            ...
                            TextFieldCustom(
                                ...
                                hint: '${_getController.getMoneyFormat(_getController.profileInfoModel.value.result!.first.cashbackRemain)} ${'so‘m'.tr}',
                                controller: _getController.paymentController,
                                errorInput: _getController.errorInput[2],
                                isNext: true,
