...
class AddCardPage extends StatelessWidget {
  ...
  /*String maskCardNumber(String cardNumber) {
    if (cardNumber.length < 8) return cardNumber; // In case the card number is too short
    ...
    return Scaffold(
        ...
        body:  Column(
            ...
            children: [
              ...
              Obx(() =>
                  Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(image: Image.asset('assets/images/card_fon_1.png').image, fit: BoxFit.cover)
                      ),
                      child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
              ...
              TextFieldCustom(fillColor: AppColors.white, hint: 'Karta raqami', mack: true, controller: _getController.cardNumberController),
              ...
              TextFieldCustom(fillColor: AppColors.white, hint: 'F.I.O', controller: _getController.nameController),
              const Spacer(),
              Container(
                  width: Get.width,
