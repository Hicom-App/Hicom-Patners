                ...
                child: Row(
                    ...
                    children: [
                      IconButton(icon: Icon(Icons.home,
                          color: _getController.index.value == 0 ? AppColors.white : AppColors.black70,
                          size: Theme.of(context).iconTheme.fill), onPressed: () => _onItemTapped(0)),
                      IconButton(icon: Icon(Icons.person,
                          color: _getController.index.value == 1 ? AppColors.white : AppColors.black70,
                      ...
                      IconButton(icon: Icon(Icons.analytics,
                          color: _getController.index.value == 2 ? AppColors.white : AppColors.black70,
                          size: Theme.of(context).iconTheme.fill), onPressed: () => _onItemTapped(2)),
                      IconButton(icon: Icon(Icons.settings,
                          color: _getController.index.value == 3 ? AppColors.white : AppColors.black70,
                          size: Theme.of(context).iconTheme.fill), onPressed: () => _onItemTapped(3))
                    ]
                )
            )
        ))
