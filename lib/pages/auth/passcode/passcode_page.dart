    ...
    return Scaffold(
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(image: AssetImage('assets/images/fon.png'), fit: BoxFit.fitWidth),
        ),
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [BoxShadow(color: AppColors.grey, spreadRadius: 5, blurRadius: 16, offset: Offset(0, 3))],
                ),
              ),
            ),
            Positioned(
                  ...
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index == 9) {
                          return Obx(() {
                            if (_getController.getBiometrics()) {
                              return IconButton(
                                icon: Icon(
                                  _getController.hasFingerprint.value
                                      ? Icons.fingerprint
                                      : _getController.hasFaceID.value
                                      ? Icons.face
                                      : null,
                                  size: 28,
                                ),
