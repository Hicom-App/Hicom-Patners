                                                    ...
                                                    child:SizedBox(
                                                      ...
                                                      child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            TextSmall(text: listPrice[index].tr, color: listColor[index],fontWeight: FontWeight.bold),
                                                          ]),
                                                    )
                                                )
                                            )
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                                ...
                                                child: Center(child: TextSmall(text: list[index].tr, color: AppColors.black.withOpacity(0.7), maxLines: 1, fontSize: 10.sp))
                                            )
                                          ]
                                      )
                                  )
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          TextSmall(text: listStar[index], color: Theme.of(context).colorScheme.onSurface, fontWeight: FontWeight.w400, maxLines: 1, fontSize: 10),
                                                        ],
                                                      )
                                                    ]
                                                )
