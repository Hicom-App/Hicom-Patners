  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshComponent(
        ...
        child: Obx(() => _getController.warrantyModel.value.result != null
            ? Column(
            children: [
              ...
              Container(
                  ...
                  child: ListView.builder(
                      shrinkWrap: true,
                      itemCount: _getController.warrantyModel.value.result!.length,
                      physics: const NeverScrollableScrollPhysics(),
                      itemBuilder: (context, index) =>
                          Column(
                              children: [
                                                    ...
                                                    child:  Column(
                                                        ...
                                                        children: [
                                                          Row(
                                                              ...
                                                              crossAxisAlignment: CrossAxisAlignment.center,
                                                              children: [
                                                                SizedBox(width: 110.w, child: TextSmall(text: _getController.warrantyModel.value.result![index].name.toString(), color: Theme.of(context).brightness == Brightness.light ? AppColors.black : AppColors.white, fontWeight: FontWeight.bold,fontSize: 18.sp)),
                                                                const Spacer(),
                                                                InkWell(onTap : () => ApiController().deleteWarrantyProduct(_getController.warrantyModel.value.result![index].id!.toInt()), child: Icon(Icons.delete, color: AppColors.red, size: 18.sp)),
                                                                SizedBox(width: 12.w)
                                                              ]
                                                          ),
                                                          SizedBox(height: 12.h),
