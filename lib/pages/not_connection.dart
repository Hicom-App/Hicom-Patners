        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              child: Icon(Icons.wifi_off_rounded, color: AppColors.red.withOpacity(0.8), size: 120.sp)
            ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [AppColors.red, AppColors.red.withOpacity(0.7)], begin: Alignment.topLeft, end: Alignment.bottomRight),
                  borderRadius: BorderRadius.circular(25.r),
                  boxShadow: [BoxShadow(color: AppColors.red.withOpacity(0.3), blurRadius: 10, offset: const Offset(0, 4))]
                ),
                child: Center(child: Text('Qayta urinish'.tr, style: TextStyle(fontFamily: 'Schyler', color: AppColors.white, fontSize: 16.sp, fontWeight: FontWeight.w600)))
              )
            )
          ]
        )
